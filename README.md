...
1.  Clone this project.
    ```
    git clone https://github.com/devmchou/de-zoomcamp-finalproject.git
    cd de-zoomcamp-finalproject
    ```
...
5.  Configuration files (3 total):
    ...
    The following configuration files contain some key parameters which should be configured with your project-specific values.
      ...
      | GOOGLE_APPLICATION_CREDENTIALS         | path to your service account key JSON file       | /Users/name/projects/de-zoomcamp-finalproject/sa-key.json|
